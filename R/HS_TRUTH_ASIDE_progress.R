...
cl <- loadData(DUMPDIR, 'truth_aside_R/')
...
ggsave(filename = paste0(IMGPATH, "truth_aside_progress_R.jpg"),
...
cl <- loadData(DUMPDIR, 'truth_aside_alpha/')
...
ggsave(filename = paste0(IMGPATH, "truth_aside_progress_alpha.jpg"),
       plot = p, width=10, height=5, dpi=300)
...
cl <- loadData(DUMPDIR, 'truth_aside_noises/')
...
ggsave(filename = paste0(IMGPATH, "truth_aside_progress_noises.jpg"),
       plot = p, width=10, height=10, dpi=300)

## TAU ##

cl <- loadData(DUMPDIR, 'truth_aside_tau/')
...
ggsave(filename = paste0(IMGPATH, "truth_aside_progress_tau.jpg"),
       plot = p, width=10, height=5, dpi=300)
