...
simName = 'nobound_alpha_20000_again';
...
nRuns = 40;             % Number of simulation-runs with same param set
...
% Computing fixed distance between interaction radii
myRadii = [0.1:0.05:1];
myGaps = myRadii * 2 * pi ./ 30 - 0.03;
myBiggerRadii = ((myGaps * 30) + 0.3*30 ) ./ (2*pi);
...
% BOUNDARY CONDITIONS
boundaries = [0]; % 0,1 no bound, bounce bound
